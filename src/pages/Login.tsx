    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 font-medium mt-2">Access your elite neural editing suite.</p>
        </div>
        ...
        <p className="text-center mt-8 text-slate-500 text-sm font-medium">
          New to the platform? <Link to="/register" className="text-blue-600 font-black uppercase tracking-widest text-xs ml-2 hover:text-blue-500">Create Identity</Link>
        </p>
      </div>
    </div>
  );
